...
The cache-bypassed live portfolio serves the interactive hero field and the updated theme control after the `e87fd23` release push. The live control successfully changed the presentation from light to dark while retaining readable hero, interaction-layer, profile, and navigation content.
