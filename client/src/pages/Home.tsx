...
const projects: Project[] = [
  ...
  {
    name: "Pizza Connect",
    tagline: "Website for a real local pizzeria & bakery in Khurja",
    description: "A luxury-feel static build with real menu data, WhatsApp-based cart checkout, and SEO and accessibility passes — currently in final steps before going live.",
    stack: ["HTML/CSS/JS", "WhatsApp API", "SEO"],
    status: "wip",
